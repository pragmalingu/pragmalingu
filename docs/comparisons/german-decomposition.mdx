...
While we mostly looked at the comparison between the decompounding and standard approaches, the **Dictionary Decompounder** was always subject to the **Hyphenation Decompounder**. Only in the [Medline corpus](../guides/data-comparison#medline) corpus there were minor deviations in the scores where the **Dictionary Decompounder** did better.
