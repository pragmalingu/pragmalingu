...
The evaluations are based on several freely available datasets which we collected. We also provide code that makes it easy to use these datasets for your own experiments. 
