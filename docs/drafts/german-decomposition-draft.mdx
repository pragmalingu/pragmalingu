...
While experimenting the scores for the **German Analyzer** always exceeded the scores of the **Standard Analyzer** and on some corpora, like [CACM](../guides/data-comparison#cacm) or [LISA](../guides/data-comparison#lisa), there was an increase of nearly 50%, even around 80% with the [ADI corpus](../guides/data-comparison#adi) (see graphic with gains in section [3. Results](#3-results)).
