...
is described
   /
```
Die größte Schwierigkeit lag darin, dass document, query und relevance assessments file unterschiedliche newlines um die entry marker hatten. Mit dieser Art zu splitten sind uns keine Daten verloren gegangen:
