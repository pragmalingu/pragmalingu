...
To be able to work with Elasticsearch we first have to index all documents. You can read about what that exactly means and how to set up an Elasticsearch instance in our [Elasticsearch Guide](../guides/elastic-setup.md).
...
Since it's easier to demonstrate parsing by using a practical example, we picked one of our [8 free available Data Sets](../comparisons/overview.md). 
