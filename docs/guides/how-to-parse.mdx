...
We could determine that the corpora [Cranfield](https://pragmalingu.de/docs/comparisons/data-comparison#cranfield), [CACM](https://pragmalingu.de/docs/comparisons/data-comparison#cacm), [CISI](https://pragmalingu.de/docs/comparisons/data-comparison#cisi) and [ADI](https://pragmalingu.de/docs/comparisons/data-comparison#adi) use very similar notations. Each document text is always marked with a line that only contains ".W" at the beginning:
...
If you don't want to determine the markers on your own, we have already done all the work by analyzing every single [Data Set](../comparisons/data-comparison.mdx) and even wrote an [Overview Table](../comparisons/overview.mdx).
...
We chose the [Cranfield Corpus](https://pragmalingu.de/docs/comparisons/data-comparison#cranfield). On the one hand because it uses the same notation as CACM, CISI and ADI, therefore the code can easily be adapted to parse the other corpora as well. 
...
(Detailed definitions of all the markers can be found [here](https://pragmalingu.de/docs/comparisons/data-comparison#cranfield))
