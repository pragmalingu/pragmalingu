...
With this Guide, we want to provide you with some quick definitions on the basic Natural Language Processing (NLP) terms used in our experiments. If there are terms that you think should be explained as well, please [let us know](https://pragmalingu.de/about).
