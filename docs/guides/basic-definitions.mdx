...
With this Guide we want to provide you some quick definitions on basic terms used in NLP. If there are terms you think should be explained as well please [let us know](../about/team.mdx).

# NLP - Natural Language processing
First, let's clarify what NLP is. NLP stands for “Natural Language Processing” and describes the handling of natural language. A natural Language is a language that was naturally developed and has evolved throughout use and repetition. There is no planning or optimization involved when rules of a natural language change somehow. This is in contrast to artificial languages or computer code.
Since Natural Language is arbitrary and does not always follow rules, it is very hard to comprehend it automated. Therefore, NLP began to get more important in the 1950s as an intersection of artificial intelligence and linguistics. Nowadays it is a separate research branch.
