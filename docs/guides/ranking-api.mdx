...
Next you need the search queries correctly formatted for the Ranking Evaluation API to read. We wrote down how you can achieve this from raw data in our [Parsing Guide](../guides/parsing-guide.mdx).
