...
We thought the results would be lower than the *stemmer token filter* relsuts but better than the standard search we used.
But that wasn't the case for all of the corpora.
