...
const siteConfig = {
  title: 'PragmaLingu', // Title for your website.
  tagline: 'Explore pragmatic search possibilities',
  url: 'https://pragmalingu.github.io', // Your website URL
  ...
  headerIcon: 'img/testicon.ico',
  footerIcon: 'img/testicon.ico',
  favicon: 'img/testicon.ico',

  /* Colors for website */
  colors: {
    primaryColor: '#3d6ef4',
    secondaryColor: '#2f51ab',
  },
  ...
  */
  ...
  copyright: `Copyright © ${new Date().getFullYear()} PragmaLingu`,
